...
const PROFILES: Record<string, Profile> = {
  ...
  "salud-clinica": {
    ...
    subtitle: "Tu vocación es cuidar la salud humana. Combinás conocimiento biológico con calidez en la atención del paciente.",
    quote: "Tenés una sensibilidad única para entender el cuerpo humano y la responsabilidad innegociable de cuidarlo. Sos de los que sostienen el sistema de salud con precisión científica y empatía genuina.",
    traits: [
      { label: "Precisión Diagnóstica", pct: "94%" },
      { label: "Empatía Clínica", pct: "92%" },
      { label: "Rigor Científico", pct: "89%" },
      { label: "Resistencia al Estrés", pct: "87%" },
      { label: "Vocación de Servicio", pct: "95%" },
    ],
    careers: ["Medicina", "Odontología", "Lic. en Enfermería", "Obstetricia", "Instrumentación Quirúrgica"],
    methods: [
      { method: "Holland", result: "Investig.-Social" },
      { method: "Gardner", result: "Naturalista-Interp." },
      { method: "Kolb", result: "Convergente" },
      { method: "Schwartz", result: "Benevolencia" },
    ],
  },
  "deporte-bienestar-corporal": {
    emoji: "🏃‍♂️",
    title: "El Promotor",
    titleHighlight: "del Deporte",
    subtitle: "El movimiento es tu lenguaje. Inspirás a otros a transformar su cuerpo, su salud y su disciplina.",
    quote: "Combinás conocimiento biomecánico con una capacidad natural para motivar. Sos de los que entienden que el rendimiento físico es la base del bienestar mental y la vida plena.",
    traits: [
      { label: "Inteligencia Kinestésica", pct: "95%" },
      { label: "Liderazgo Motivacional", pct: "89%" },
      { label: "Disciplina Personal", pct: "92%" },
      { label: "Conocimiento Anatómico", pct: "84%" },
      { label: "Energía Aplicada", pct: "90%" },
    ],
    careers: ["Profesorado en Educación Física", "Lic. en Alto Rendimiento Deportivo", "Gestión Deportiva", "Psicomotricidad"],
    methods: [
      { method: "Holland", result: "Social-Realista" },
      { method: "Gardner", result: "Kinestésica" },
      { method: "Kolb", result: "Acomodador" },
      { method: "Schwartz", result: "Estimulación" },
    ],
  },
  "salud-rehabilitacion": {
    ...
    titleHighlight: "de la Rehabilitación",
    subtitle: "Tu misión es devolverle la funcionalidad al cuerpo y la voz a quien la perdió. Sanás con paciencia y técnica.",
    quote: "Tenés una mezcla rara entre rigor científico y profunda empatía. Sos de los que sostienen procesos largos con dedicación, viendo el potencial que otros descartan.",
    traits: [
      { label: "Paciencia Terapéutica", pct: "93%" },
      { label: "Precisión Técnica", pct: "88%" },
      { label: "Lectura Corporal", pct: "90%" },
      { label: "Constancia", pct: "92%" },
      { label: "Empatía Activa", pct: "94%" },
    ],
    careers: ["Kinesiología y Fisiatría", "Terapia Ocupacional", "Fonoaudiología"],
    methods: [
      { method: "Holland", result: "Social-Investig." },
      { method: "Gardner", result: "Kinestésica-Interp." },
      { method: "Kolb", result: "Convergente" },
      { method: "Schwartz", result: "Benevolencia" },
    ],
  },
  "desarrollador-mecanico-industrial": {
    emoji: "⚙️",
    title: "El Desarrollador",
    titleHighlight: "Mecánico e Industrial",
    subtitle: "Diseñás máquinas, vehículos y sistemas que mueven al mundo. La mecánica y la automatización son tu lenguaje.",
    quote: "Tu cabeza piensa en sistemas físicos: engranajes, motores, robots, líneas de producción. Sos de los que llevan la ingeniería a su expresión más tangible y precisa.",
    traits: [
      { label: "Pensamiento Mecánico", pct: "93%" },
      { label: "Rigor Técnico", pct: "91%" },
      { label: "Visualización Espacial", pct: "88%" },
      { label: "Resolución de Problemas", pct: "90%" },
      { label: "Precisión Cuantitativa", pct: "86%" },
    ],
    careers: ["Ingeniería Mecánica", "Ing. Electrónica", "Automatización y Robótica Industrial", "Ing. Automotriz", "Ing. Aeronáutica / Naval"],
    methods: [
      { method: "Holland", result: "Realista-Investig." },
      { method: "Gardner", result: "Lógico-Espacial" },
      { method: "Kolb", result: "Convergente" },
      { method: "Schwartz", result: "Logro" },
    ],
  },
  "optimizador-logistico": {
    emoji: "📦",
    title: "El Optimizador",
    titleHighlight: "de Procesos",
    subtitle: "Donde otros ven caos, vos ves un sistema esperando ser optimizado. Convertís complejidad en eficiencia medible.",
    quote: "Tu mente piensa en flujos, cuellos de botella y métricas. Sos de los que hacen que las cadenas de valor funcionen, que las empresas escalen y que los recursos rindan.",
    traits: [
      { label: "Pensamiento Sistémico", pct: "92%" },
      { label: "Eficiencia Operativa", pct: "94%" },
      { label: "Análisis Cuantitativo", pct: "89%" },
      { label: "Gestión de Recursos", pct: "91%" },
      { label: "Orientación a Procesos", pct: "90%" },
    ],
    careers: ["Ingeniería Industrial", "Lic. en Logística y Supply Chain", "Gestión de la Producción"],
    methods: [
      { method: "Holland", result: "Convenc.-Realista" },
      { method: "Gardner", result: "Lógico-Matemático" },
      { method: "Kolb", result: "Asimilador" },
      { method: "Schwartz", result: "Logro" },
    ],
  },
  "produccion-agro-tierra": {
    emoji: "🚜",
    title: "El Desarrollador",
    titleHighlight: "Agropecuario",
    subtitle: "Tu vocación está donde la ciencia se encuentra con la tierra. Producís lo que el país y el mundo necesitan para alimentarse.",
    quote: "Combinás conocimiento biológico, técnico y económico para hacer producir el campo de forma sustentable. Sos parte de la columna vertebral productiva del país.",
    traits: [
      { label: "Conexión con la Tierra", pct: "92%" },
      { label: "Conocimiento Biológico", pct: "88%" },
      { label: "Visión Productiva", pct: "90%" },
      { label: "Trabajo en Terreno", pct: "94%" },
      { label: "Sustentabilidad", pct: "85%" },
    ],
    careers: ["Ingeniería Agronómica", "Medicina Veterinaria", "Ingeniería Zootecnista", "Tecnicatura en Producción Agropecuaria"],
    methods: [
      { method: "Holland", result: "Realista-Investig." },
      { method: "Gardner", result: "Naturalista" },
      { method: "Kolb", result: "Acomodador" },
  ...
  "creador-contenido-media": {
    emoji: "🎬",
    title: "El Creador",
    titleHighlight: "de Contenido y Media",
    subtitle: "Tu mente combina arte, narrativa y tecnología para crear universos audiovisuales que entretienen a millones.",
    quote: "Sos el puente entre la imaginación y la pantalla. Tu campo es donde el cine, los videojuegos, la animación y el sonido se cruzan para construir experiencias inolvidables.",
    traits: [
      { label: "Creatividad Audiovisual", pct: "94%" },
      { label: "Narrativa Visual", pct: "91%" },
      { label: "Dominio Técnico Digital", pct: "88%" },
      { label: "Sensibilidad Estética", pct: "92%" },
      { label: "Innovación de Formatos", pct: "87%" },
    ],
    careers: ["Diseño y Desarrollo de Videojuegos", "Lic. en Cine y Artes Audiovisuales", "Animación 3D y Efectos Visuales (VFX)", "Producción Musical / Diseño de Sonido"],
    methods: [
      { method: "Holland", result: "Artístico-Investig." },
      { method: "Gardner", result: "Visual-Musical" },
      { method: "Kolb", result: "Divergente" },
      { method: "Schwartz", result: "Estimulación" },
    ],
  },
  "analista-legal-datos": {
    emoji: "🔏",
    title: "El Analista",
    titleHighlight: "de Riesgo y Datos",
    subtitle: "Tu campo es la zona gris entre la tecnología y la ley. Detectás amenazas, auditás sistemas y protegés información crítica.",
    quote: "Combinás pensamiento lógico con rigor normativo. Sos de los que entienden que en la economía digital, la información es el activo más valioso y el más vulnerable.",
    traits: [
      { label: "Pensamiento Analítico", pct: "93%" },
      { label: "Atención al Detalle", pct: "95%" },
      { label: "Conocimiento Normativo", pct: "89%" },
      { label: "Razonamiento Forense", pct: "90%" },
      { label: "Confidencialidad", pct: "94%" },
    ],
    careers: ["Tecnicatura en Ciberseguridad", "Peritaje Informático Forense", "Compliance Officer / Auditoría de Datos"],
    methods: [
      { method: "Holland", result: "Investig.-Convenc." },
      { method: "Gardner", result: "Lógico-Matemático" },
      { method: "Kolb", result: "Asimilador" },
      { method: "Schwartz", result: "Seguridad" },
    ],
  },
  "divulgador-humanistico": {
    emoji: "📚",
    title: "El Divulgador",
    titleHighlight: "Humanístico",
    subtitle: "Convertís el conocimiento en algo accesible. Tu vocación es transmitir cultura, historia y pensamiento a las próximas generaciones.",
    quote: "Tu cabeza vive entre los libros, las ideas y las palabras. Sos de los que entienden que educar es la forma más profunda de transformar una sociedad.",
    traits: [
      { label: "Capacidad Pedagógica", pct: "94%" },
      { label: "Pensamiento Crítico", pct: "91%" },
      { label: "Comunicación Clara", pct: "92%" },
      { label: "Curiosidad Cultural", pct: "93%" },
      { label: "Paciencia Didáctica", pct: "89%" },
    ],
    careers: ["Profesorado en Historia", "Profesorado en Letras", "Profesorado en Filosofía", "Profesorado en Geografía", "Ciencias de la Educación"],
    methods: [
      { method: "Holland", result: "Social-Artístico" },
      { method: "Gardner", result: "Lingüístico-Interp." },
      { method: "Kolb", result: "Asimilador" },
  ...
  "disenador-tecnico-espacial": {
    emoji: "📐",
    title: "El Diseñador",
    titleHighlight: "Técnico y Espacial",
    subtitle: "Pensás en planos, escalas y proporciones. Diseñás los espacios y los objetos que la gente va a habitar y usar todos los días.",
    quote: "Combinás creatividad estética con rigor técnico. Tu mente proyecta en tres dimensiones: imaginás lo que no existe y lo traducís a algo construible y funcional.",
    traits: [
      { label: "Visualización Espacial", pct: "95%" },
      { label: "Sensibilidad Estética", pct: "90%" },
      { label: "Rigor Técnico", pct: "88%" },
      { label: "Pensamiento Proyectual", pct: "92%" },
      { label: "Atención al Detalle", pct: "89%" },
    ],
    careers: ["Arquitectura", "Diseño Industrial", "Diseño de Interiores", "Planificación Urbana"],
    methods: [
      { method: "Holland", result: "Artístico-Realista" },
      { method: "Gardner", result: "Visual-Espacial" },
      { method: "Kolb", result: "Convergente" },
      { method: "Schwartz", result: "Auto-Dirección" },
    ],
  },
  "tecnico-quimico-biologico": {
    emoji: "🧪",
    title: "El Técnico",
    titleHighlight: "Químico y Biológico",
    subtitle: "Trabajás en el laboratorio donde se decide el futuro de la salud, los alimentos y la biotecnología argentina.",
    quote: "Tu vocación está en lo microscópico: células, moléculas, reacciones. Sos de los que entienden que los grandes avances de la humanidad nacen en una mesada de laboratorio.",
    traits: [
      { label: "Rigor Experimental", pct: "94%" },
      { label: "Precisión de Laboratorio", pct: "93%" },
      { label: "Curiosidad Científica", pct: "91%" },
      { label: "Pensamiento Molecular", pct: "89%" },
      { label: "Constancia Investigativa", pct: "88%" },
    ],
    careers: ["Biotecnología", "Farmacia", "Bioquímica", "Licenciatura en Química / Genética"],
    methods: [
      { method: "Holland", result: "Investig.-Realista" },
      { method: "Gardner", result: "Naturalista-Lógico" },
      { method: "Kolb", result: "Asimilador" },
      { method: "Schwartz", result: "Logro" },
    ],
  },
