...
const INFORMES: Record<string, InformeData> = {
  ...
  "explorador-naturalista": {
    ...
    careers: [
      { name: "Biología y Ecología", match: "96%", projection: "9/10", summary: "Estudiás y protegés los sistemas vivos que sostienen el planeta.", image: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=600&q=80", badge: "Propósito", duration: "5 años", queEstudia: "Biología celular, ecología, taxonomía, conservación y metodología de campo.", queHace: "Investiga ecosistemas, diseña planes de conservación y asesora políticas ambientales.", universities: ["UBA (Argentina)", "UNAM (México)", "U. de Chile"] },
  ...
  "comunicador-estrategico": {
    ...
    careers: [
      ...
      { name: "Periodismo Digital e Investigativo", match: "85%", projection: "9/10", summary: "Investigás y narrás las historias que la sociedad necesita conocer.", image: "https://images.unsplash.com/photo-1504711434969-e33886168f5c?auto=format&fit=crop&w=600&q=80", badge: "Propósito", duration: "4 años", queEstudia: "Periodismo digital, datos abiertos, investigación periodística y ética mediática.", queHace: "Reporta, investiga y publica historias de impacto social usando datos, fuentes y narrativa multimedia.", universities: ["UNLP (Argentina)", "UNAM (México)", "U. de Chile"] },
    ],
    roadmap: [
  ...
  "lider-emprendedor": {
    ...
    careers: [
      ...
      { name: "Marketing Estratégico y Growth", match: "87%", projection: "9/10", summary: "Diseñás las estrategias que hacen crecer marcas y productos de forma exponencial.", image: "https://images.unsplash.com/photo-1611532736597-de2d4265fba3?auto=format&fit=crop&w=600&q=80", badge: "Tendencia", duration: "4 años", queEstudia: "Marketing, comportamiento del consumidor, growth hacking, branding y analítica.", queHace: "Diseña estrategias de adquisición y retención, lidera campañas y optimiza el funnel de crecimiento.", universities: ["UCEMA (Argentina)", "TEC Campus Ciudad de México", "P. Universidad Católica (Chile)"] },
    ],
    roadmap: [
  ...
  "agente-cambio": {
    ...
    careers: [
      { name: "Derecho y Derechos Humanos", match: "96%", projection: "9/10", summary: "Usás el sistema legal como herramienta de justicia y transformación social.", image: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=600&q=80", badge: "Propósito", duration: "5 años", queEstudia: "Derecho constitucional, derechos humanos, derecho penal, litigio estratégico y derecho internacional.", queHace: "Litiga casos de impacto, asesora a organizaciones de la sociedad civil y diseña políticas públicas.", universities: ["UBA (Argentina)", "UNAM (México)", "U. de Chile"] },
      ...
      { name: "Periodismo de Investigación", match: "85%", projection: "8/10", summary: "Investigás y exponés las verdades que el poder prefiere ocultar.", image: "https://images.unsplash.com/photo-1504711434969-e33886168f5c?auto=format&fit=crop&w=600&q=80", badge: "Propósito", duration: "4 años", queEstudia: "Periodismo, datos abiertos, técnicas de investigación y ética periodística.", queHace: "Investiga casos de corrupción, violaciones de derechos humanos y diseña reportajes de impacto social.", universities: ["UNLP (Argentina)", "UNAM (México)", "U. de Chile"] },
    ],
    roadmap: [
  ...
  "estratega-negocios": {
    ...
    careers: [
      ...
      { name: "Finanzas Corporativas y Banca", match: "90%", projection: "10/10", summary: "Manejás y optimizás el flujo de capital de empresas e instituciones financieras.", image: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=600&q=80", badge: "Alta Demanda", duration: "4–5 años", queEstudia: "Finanzas corporativas, mercados de capitales, contabilidad avanzada y modelos de valoración.", queHace: "Evalúa inversiones, estructura financiamientos, analiza carteras y asesora en operaciones de capital.", universities: ["UBA (Argentina)", "ITAM (México)", "PUC (Chile)"] },
      { name: "Administración y Project Management", match: "87%", projection: "9/10", summary: "Liderás la ejecución de proyectos complejos de alto impacto organizacional.", image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=600&q=80", badge: "Versátil", duration: "4 años", queEstudia: "Administración de proyectos, gestión de operaciones, liderazgo de equipos y metodologías ágiles.", queHace: "Coordina proyectos multidisciplinarios, gestiona riesgos y tiempos, y asegura el delivery de resultados en plazo y presupuesto.", universities: ["UCEMA (Argentina)", "ITESM (México)", "UAI (Chile)"] },
    ],
    roadmap: [
